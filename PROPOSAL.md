...
* **Individual Use-Case Diagrams:**
    * ![Use Case - Role 1](link-to-image) *(Replace with actual diagram for Role 1)*
    * ![Use Case - Role 2](link-to-image) *(Replace with actual diagram for Role 2)*
    * ![Use Case - Role 3](link-to-image) *(Replace with actual diagram for Role 3)*
    
    *(Note: Ensure there is exactly one individual use-case diagram for each identified role).*

### 4.2 Audience Characterization
*(Note: As per module requirements, each identified role must have at least 3 tables detailing their specific requirements).*

#### 👤 Role 1: [Insert Role Name]

**Table 1: Functional Requirements**
| Req ID | Requirement Description | Priority |
| :--- | :--- | :--- |
| FR-1.1 | *[e.g., User must be able to log in using APU credentials]* | High |
| FR-1.2 | *[Description]* | Medium |

**Table 2: Usability Requirements**
| Req ID | Requirement Description | Metric / Goal |
| :--- | :--- | :--- |
| UR-1.1 | *[e.g., The dashboard should load within 2 seconds]* | Performance |
| UR-1.2 | *[Description]* | Accessibility |

**Table 3: Navigational Requirements**
| Req ID | Requirement Description | Target Path / View |
| :--- | :--- | :--- |
| NR-1.1 | *[e.g., User can access settings from the profile dropdown]* | `/user/settings` |
| NR-1.2 | *[Description]* | *[Path]* |

*(Duplicate the three tables above for **Role 2**, **Role 3**, etc., to satisfy the minimum 3 tables per role rule).*
